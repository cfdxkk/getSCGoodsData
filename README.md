# getSCGoodsData
  ...
  This jar software can search Goods(such as ships) info from the game data，before you use it, you should get ~java1.8,  [unp4k](https://github.com/dolkensp/unp4k) and unforge, Now you can easy to download unp4k and unforge in `dev`</br></br>
  当然，我更希望您可以前往 [unp4k在github的官方库](https://github.com/dolkensp/unp4k) 给原作者一个star</br>
  Of couse, I wish you can learn more at [unp4k official lib on Github](https://github.com/dolkensp/unp4k), and don't forget give a star</br></br>
